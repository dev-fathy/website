...
<head>
	...
	<!-- Custom Theme files -->
	<link href="{{ asset('fashion/css/bootstrap.css')  }}" type="text/css" rel="stylesheet" media="all">
	<!-- shop css -->
	<link href="{{ asset('fashion/css/shop.css')  }}" type="text/css" rel="stylesheet" media="all">
	...
	<!-- font-awesome icons -->
	<link href="{{ asset('fashion/css/fontawesome-all.min.css')  }}" rel="stylesheet">
	<!-- //Custom Theme files -->
	<!-- online-fonts -->
