                ...
                <div class="row  footer-v2grids w3-agileits">
                    ...
                    <div class="col-lg-3 col-sm-6 footer-v2grid mt-sm-0 mt-5">
                        ...
                        <div class="footer-v2grid1 row">
                            <div class="col-4 footer-v2grid1-left">
                                <a href="blog.html">
                                    <img src="{{ asset('fashion/images/bl2.jpg') }}" alt=" " class="img-fluid">
                                </a>
                            </div>
                        ...
                        <div class="footer-v2grid1 row my-2">
                            <div class="col-4 footer-v2grid1-left">
                                <a href="blog.html">
                                    <img src="{{ asset('fashion/images/bl1.jpg') }}" alt=" " class="img-fluid">
                                </a>
                            </div>
                            <div class="col-8 footer-v2grid1-right p-0">
                        ...
                        <div class="footer-v2grid1 row">
                            <div class="col-4 footer-v2grid1-left">
                                <a href="blog.html">
                                    <img src="{{ asset('fashion/images/bl3.jpg') }}" alt=" " class="img-fluid">
                                </a>
                            </div>
                            <div class="col-8 footer-v2grid1-right p-0">
                    ...
                    <div class="col-lg-3 col-sm-6 footer-v2grid my-lg-0 my-sm-5">
                        ...
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                                <img src="{{ asset('fashion/images/bl4.jpg') }}" alt=" " class="img-fluid">
                            </a>
                        </div>
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                        ...
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                                <img src="{{ asset('fashion/images/bl6.jpg') }}" alt=" " class="img-fluid">
                            </a>
                        </div>
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                                <img src="{{ asset('fashion/images/bl5.jpg') }}" alt=" " class="img-fluid">
                            </a>
                        </div>
                ...
                <div class="mt-2 sub-some align-self-lg-center">
                    ...
                    <ul class="mt-4">
                        <li class="list-inline-item">
                            <img src="{{ asset('fashion/images/pay2.png') }}" alt="">
                        </li>
                        <li class="list-inline-item">
                            <img src="{{ asset('fashion/images/pay5.png') }}" alt="">
                        </li>
                        <li class="list-inline-item">
                            <img src="{{ asset('fashion/images/pay3.png') }}" alt="">
                        </li>
                        <li class="list-inline-item">
                            <img src="{{ asset('fashion/images/pay7.png') }}" alt="">
                        </li>
                        <li class="list-inline-item">
                            <img src="{{ asset('fashion/images/pay8.png') }}" alt="">
                        </li>
                        <li class="list-inline-item ">
                            <img src="{{ asset('fashion/images/pay9.png') }}" alt="">
                        </li>
                    </ul>
                </div>
...
@include('modals.sign_in')
@include('modals.footer_scripts')
