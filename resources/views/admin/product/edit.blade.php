...
<div class="col-md-12">
    ...
    <div class="card">
        ...
        <form action="{{ url('product',$prods->id)  }}" method="post" enctype="multipart/form-data"
            ...
            <div class="card-body card-block">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="name" placeholder="Product name"
                            value="{{$prods->name}}" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <img src="{{ asset('/storage/images/products/'. $prods->image) }}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="SKE" value="{{$prods->SKE}}"
                            placeholder="SKE code of Product" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="price" value="{{$prods->price}} placeholder="Price of Product"
                            class="form-control">
